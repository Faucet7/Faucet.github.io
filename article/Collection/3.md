...
🪝**抓包软件**：抓包用的是[fiddler](https://www.telerik.com/fiddler)，也是老牌好用的抓包软件，点此查看[fiddler原理、下载及手机端抓包配置教程]([Fiddler抓包原理和使用详解 - sucre_tan - 博客园 (cnblogs.com)](https://www.cnblogs.com/sucretan2010/p/11526467.html))。
